...
const EditMoviePage = lazy(() => import('@/pages/Edit/movies/index').then(m => ({ default: m.EditMoviePage })));
const EditPlaylistPage = lazy(() => import('@/pages/Edit/playlists/index').then(m => ({ default: m.EditPlaylistPage })));
