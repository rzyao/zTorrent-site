...
function ContextMenuSubContent({
  ...
  return (
    <ContextMenuPrimitive.SubContent
      ...
      className={cn(
        "bg-white text-[#202124] data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 z-50 min-w-[12rem] origin-(--radix-context-menu-content-transform-origin) overflow-hidden rounded-lg border border-[#DADCE0] p-1.5 shadow-[0_2px_8px_rgba(0,0,0,0.15)]",
        className,
      )}
      {...props}
    />
...
function ContextMenuSeparator({
  ...
  return (
    <ContextMenuPrimitive.Separator
      ...
      className={cn("bg-[#E8EAED] -mx-1 my-1 h-px", className)}
      {...props}
    />
  );
}
