        ...
        <div className="w-full max-w-md">
          <div className="bg-black/60 backdrop-blur-md rounded-lg p-8 md:p-10 border border-gray-800">
            ...
            <form className="space-y-5" onSubmit={handleSubmit}>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    placeholder="选择一个用户名"
                    className={`w-full bg-gray-900/50 border-gray-700 text-white pl-11 pr-4 py-6 rounded-md focus:border-[#00A8E1] focus:ring-[#00A8E1] placeholder:text-gray-500 ${errors.username ? 'border-red-500' : ''
                      }`}
                    required
                  />
                </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    placeholder="设置登录密码"
                    className={`w-full bg-gray-900/50 border-gray-700 text-white pl-11 pr-4 py-6 rounded-md focus:border-[#00A8E1] focus:ring-[#00A8E1] placeholder:text-gray-500 ${errors.password ? 'border-red-500' : ''
                      }`}
                    required
                  />
                </div>
              ...
              {/* 确认密码 */}
              <div className="space-y-2">
                <label className="text-white text-sm">确认密码</label>
                <div className="relative">
                  <Lock className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-400" />
                  <Input
                    type="password"
                    ...
                    placeholder="再次输入密码"
                    className={`w-full bg-gray-900/50 border-gray-700 text-white pl-11 pr-4 py-6 rounded-md focus:border-[#00A8E1] focus:ring-[#00A8E1] placeholder:text-gray-500 ${errors.confirmPassword ? 'border-red-500' : ''
                      }`}
                    required
                  />
                </div>
