...
import { useBanDaysLogic } from "./useBanDaysLogic";
import { BanDayModal } from "./BanDayModal";
...
/**
 * 封禁时长管理页面
 * 页面组件仅负责 UI 渲染，核心逻辑由 useBanDaysLogic Hook 提供
 */
  ...
  return (
    <>
      ...
      <div className="mb-4 flex items-center justify-between">
        <h1 className="text-xl font-semibold text-neutral-900">封禁时长管理</h1>
      </div>
      ...
      <ConfirmModal
        ...
        content={
          <div className="space-y-2">
            <div className="text-gray-600">确定要删除该封禁时长吗？</div>
            {deleteRecord && (
