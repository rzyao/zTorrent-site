...
import { BAN_DAY_CATEGORY, BanDay } from "./types";
 ...
 * 支持创建与编辑模式自适应
 */
export const BanDayModal: React.FC<BanDayModalProps> = ({
  open,
  onOpenChange,
  record,
  onSuccess,
    ...
    >
      <form className="space-y-4">
        ...
        <div className="grid gap-2">
          ...
          <Input
            id="key"
            placeholder="请输入键值 (如: 7d、30d、permanent)"
            {...register("key")}
            disabled={isEdit}
          />
        ...
        <div className="grid gap-2">
          ...
          <Input
            id="label"
            placeholder="请输入显示名称 (如: 7天、30天、永久)"
            {...register("label")}
          />
