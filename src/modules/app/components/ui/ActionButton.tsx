...
const actionButtonVariants = cva(
  "relative flex cursor-pointer items-center justify-center gap-2 overflow-hidden rounded-full text-sm tracking-wider uppercase shadow-md transition-all duration-200 outline-none select-none focus-visible:ring-2 focus-visible:ring-offset-2 active:scale-95 active:shadow-sm disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      color: {
        indigo:
