import type { Song, Album, Playlist, PlayMode, LibraryView, DetailTab } from "@/modules/app/pages/PlayerPage/types";
import { formatTime } from "@/modules/app/pages/PlayerPage/utils";
import { usePlayer } from "@/modules/app/pages/PlayerPage/hooks/usePlayer";
// 采用别名避免与本文件内同名旧组件冲突，确保使用抽离后的纯展示组件
import { PageHeader as PageHeaderExt } from "@/modules/app/pages/PlayerPage/components/PageHeader";
import { LibrarySidebar as LibrarySidebarExt } from "@/modules/app/pages/PlayerPage/components/LibrarySidebar";
import { LikedSongsView as LikedSongsViewExt } from "@/modules/app/pages/PlayerPage/components/LikedSongsView";
import { AlbumsView as AlbumsViewExt } from "@/modules/app/pages/PlayerPage/components/AlbumsView";
import { PlaylistsView as PlaylistsViewExt } from "@/modules/app/pages/PlayerPage/components/PlaylistsView";
import { PlaylistDetailView as PlaylistDetailViewExt } from "@/modules/app/pages/PlayerPage/components/PlaylistDetailView";
// 新增：引入已拆分的底部控制栏与播放详情组件
import { PlayerBar } from "@/modules/app/pages/PlayerPage/components/PlayerBar";
import { PlayerDetail } from "@/modules/app/pages/PlayerPage/components/PlayerDetail";
import { CreatePlaylistModal } from "@/modules/app/pages/PlayerPage/components/CreatePlaylistModal";
import { AddToPlaylistModal } from "@/modules/app/pages/PlayerPage/components/AddToPlaylistModal";

/** 类型已移至 '@/modules/app/pages/PlayerPage/types' */
...
/** 工具函数已移至 '@/modules/app/pages/PlayerPage/utils' */
