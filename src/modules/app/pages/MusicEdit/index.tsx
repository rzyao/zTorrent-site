      ...
      <div className="max-w-[1600px] mx-auto px-4 md:px-8 py-8">
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              <h1 className="text-white text-3xl">{t('music.editTitle')}</h1>
              <p className="text-neutral-400 text-sm mt-1">{t('music.editSubtitle')}</p>
            </div>
          </div>
          ...
          <div className="flex items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              >
                ...
                {activeTab === "songs" ? t('music.addSong') : activeTab === "artists" ? t('music.addArtist') : t('music.addAlbum')}
              </button>
            </div>
          </div>
        </div>
