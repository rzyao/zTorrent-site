  ...
  const mockCandidates: Candidate[] = [
    {
      ...
      description:
        "《沙丘2》是丹尼斯·维伦纽瓦执导的史诗科幻巨制，改编自弗兰克·赫伯特的同名小说。影片延续前作故事，讲述保罗·厄崔迪与弗雷曼人联手对抗哈克南家族的复仇之旅。在契妮和弗雷曼战士的帮助下，保罗踏上复仇之路，必须在挚爱与已知宇宙命运之间做出抉择。",
      mediainfo:
        "Video: HEVC 3840x2160 23.976fps\nAudio: DTS-HD MA 7.1 48kHz\nSubtitles: CHS, CHT, ENG",
    ...
    },
    {
      ...
      description:
        '克里斯托弗·诺兰执导的传记片，讲述"原子弹之父"罗伯特·奥本海默的传奇一生。影片聚焦于奥本海默在二战期间领导曼哈顿计划，开发出人类历史上第一颗原子弹的过程，以及战后他因反对氢弹研发而遭受的政治迫害。',
      mediainfo:
        "Video: AVC 3840x2160 23.976fps\nAudio: DTS-HD MA 5.1 48kHz\nSubtitles: CHS, CHT, ENG",
    ...
    },
    {
      ...
      description:
        "漫威宇宙蜘蛛侠系列第三部，三代蜘蛛侠同框的史诗级作品。彼得·帕克的身份被揭露后，他向奇异博士寻求帮助，却意外打开多元宇宙，导致其他宇宙的反派闯入。",
    ...
    },
    {
      ...
      description:
        "获得奥斯卡最佳影片的科幻喜剧片，讲述华裔女性在多元宇宙中的冒险故事。一位普通的华裔中年妇女伊芙琳，在申报税务时突然被卷入多元宇宙的战争，必须连接其他宇宙的自己来拯救世界。",
      mediainfo:
        "Video: HEVC 3840x2160 23.976fps HDR10\nAudio: Atmos 48kHz\nSubtitles: CHS, CHT, ENG",
    ...
    },
    {
      ...
      quality: "4K UHD BluRay HEVC",
      description:
        "丹尼斯·维伦纽瓦执导的科幻经典续作，故事设定在前作30年后。新一代银翼杀手K发现一个足以颠覆社会的秘密，这让他踏上寻找失踪30年的前银翼杀手迪卡德的旅程。",
      mediainfo:
        "Video: HEVC 3840x2160 23.976fps\nAudio: DTS-HD MA 7.1 48kHz\nSubtitles: CHS, CHT, ENG",
      ...
      <div className="mx-auto max-w-[1400px] px-4 py-8 md:px-8">
        ...
        {filteredCandidates.length === 0 && (
          <div className="py-16 text-center">
            <svg
              className="mx-auto mb-4 h-16 w-16 text-neutral-600"
              viewBox="0 0 24 24"
              fill="none"
