...
export class MoviesService {
     ...
     * @throws ApiError
     */
    public static movieBaseControllerCreate(
     ...
     * @throws ApiError
     */
    public static movieBaseControllerUpdate(
     ...
     * @throws ApiError
     */
    public static movieBaseControllerDelete(
     ...
     * @throws ApiError
     */
    public static movieBaseControllerGetDetail(
     ...
     * @throws ApiError
     */
    public static movieBaseControllerList(
