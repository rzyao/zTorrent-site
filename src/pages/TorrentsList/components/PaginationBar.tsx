 ...
 */
export function PaginationBar({ currentPage, totalPages, onChangePage }: PaginationBarProps) {
      ...
      <div className="flex items-center gap-2">
        {pages.map((pageNum, i) => (
          <Button
            ...
            className={`w-10 h-10 rounded-md transition-colors ${currentPage === pageNum ? 'bg-[#00A8E1] text-white' : 'bg-gray-900 text-gray-400 hover:bg-gray-800'}`}
          >
            {pageNum}
          </Button>
        ))}
