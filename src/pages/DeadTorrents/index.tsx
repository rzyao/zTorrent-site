...
export function DeadTorrentsPage() {
  ...
  const myPublishedTorrents: DeadTorrent[] = [
    ...
    },
    {
      ...
      seeders: 0,
      poster: 'https://images.unsplash.com/photo-1606603696914-1d77f6f004ce?w=300&h=450&fit=crop',
      category: '电影',
      reason: '服务器维护',
      publisher: 'MovieFan',
      bounty: 3560.0,
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-neutral-900 via-stone-900 to-neutral-950 pt-16">
      <div className="max-w-[1400px] mx-auto px-4 md:px-8 py-8">
        ...
        <Toolbar activeTab={activeTab} sortBy={sortBy} onSortChange={setSortBy} />
