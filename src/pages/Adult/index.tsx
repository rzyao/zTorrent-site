 ...
 * - 去除 HomeLayout 后将分类导航直接置于页面顶部，保持现有粘性样式与布局不变
 * - 路由策略：/home（全部）、/home/movie（电影）、/home/:category（其他分类为中文编码）
...
export default function HomePage() {
   ...
   * 分类选择映射规则：
   * - 全部 → /home
   * - 电影 → /home/movie（与路由保持一致，修正过去 /home/movies 的不一致）
   * - 其他中文标签 → /home/{中文编码}
   */
...
/**
 * 以下示例数据保持与原首页一致，仅用于演示布局与组件组合
 * 后续可迁移为 hooks（如 useHomeSections）以便与后端数据对接
 */
