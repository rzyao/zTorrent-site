                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {faq.tags.map((tag) => (
                        <Badge
                          key={tag}
                          className="bg-neutral-700/30 text-neutral-400 text-xs"
                        >
                          {tag}
                        </Badge>
                      ))}
        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="text-neutral-300 mb-4">
              如果以上常见问题无法解决您的疑问,您可以创建工单向我们寻求帮助。我们的支持团队会尽快为您解答。
            </p>
            <button className="px-4 py-2 bg-gradient-to-r from-amber-500 to-orange-600 hover:from-amber-600 hover:to-orange-700 text-white rounded-xl transition-all">
              创建工单
            </button>
          </div>
        </div>
