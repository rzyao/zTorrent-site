              ...
              {ticket.messages.map((message, index) => {
                ...
                return (
                  ...
                  >
                    {/* 头像 */}
                    <div
                      className={`w-10 h-10 rounded-full flex items-center justify-center flex-shrink-0 ${isStaff
                    ...
                    <div className={`flex-1 max-w-[80%] ${isStaff ? '' : 'flex flex-col items-end'}`}>
                      ...
                      <div className={`flex items-center gap-2 mb-1 ${isStaff ? '' : 'flex-row-reverse'}`}>
                        <span
                          className={`text-sm ${isStaff ? 'text-amber-400' : 'text-neutral-300'
                            }`}
                        >
                          {message.author}
                        </span>
                      ...
                      {/* 消息气泡 */}
                      <div
                        className={`rounded-2xl p-4 ${isStaff
