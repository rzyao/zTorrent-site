  ...
  useEffect(() => {
    ...
    const load = async () => {
      ...
      try {
        ...
        const cmts = Array.isArray(data?.comments) ? data.comments.map((c: any, i: number) => ({
          id: c?.id ?? i,
        ...
        const rel = Array.isArray(data?.relatedTorrents) ? data.relatedTorrents.map((t: any) => ({
          id: t?.id,
          title: str(t?.title ?? ''),
          size: str(t?.size ?? ''),
          ...
          <div className="max-w-[1400px] mx-auto px-4 md:px-8 py-8">
            ...
            <div className="mb-6">
              <div className="flex items-start justify-between mb-3">
                <div className="flex-1">
                  <h1 className="text-white text-2xl md:text-3xl mb-2">{torrentData.title}</h1>
                  {torrentData.subTitle && (
                    <p className="text-white text-lg">{torrentData.subTitle}</p>
                  )}
                  {loading && (
              ...
              <div className="flex flex-wrap items-center gap-3 text-xs text-gray-400 mb-3">
                ...
                {torrentData.uploaderLevel && (
                  <Badge className="ml-1 bg-orange-500 text-white text-xs">{torrentData.uploaderLevel}</Badge>
                )}
                {torrentData.imdb && (
                  <>
                    <span className="text-gray-600">|</span>
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-6">
                ...
                {lightboxOpen && (
                  <div className="fixed inset-0 bg-black/95 z-[900]" onClick={() => setLightboxOpen(false)} />
                )}
                ...
                <div className="bg-gray-900/50 rounded-lg border border-gray-800 overflow-hidden">
                  ...
                  >
                    ...
                    {isMediaInfoExpanded ? <ChevronUp className="w-5 h-5 text-gray-400" /> : <ChevronDown className="w-5 h-5 text-gray-400" />}
                  </div>
                  {isMediaInfoExpanded && (
                    <div className="p-4">
                ...
                <div className="bg-gray-900/50 rounded-lg border border-gray-800 overflow-hidden">
                  ...
                  >
                    ...
                    {isFilesExpanded ? <ChevronUp className="w-5 h-5 text-gray-400" /> : <ChevronDown className="w-5 h-5 text-gray-400" />}
                  </div>
                  {isFilesExpanded && (
                        ...
                        <div key={comment.id} className="flex gap-4">
                          ...
                          <div className="flex-1">
                            <div className="flex items-center gap-2 mb-2">
                              ...
                              <Badge className="bg-purple-500 text-white text-xs">{comment.userLevel}</Badge>
              ...
              <div className="space-y-6 hidden">
                    ...
                    <table className="w-full text-sm">
                      <tbody>
                        <tr className="border-b border-gray-800">
                          ...
                          <td className="px-4 py-2.5 text-white">{torrentData.category}</td>
                        </tr>
                        <tr className="border-b border-gray-800">
                          <td className="px-4 py-2.5 text-gray-400">媒介</td>
                          <td className="px-4 py-2.5 text-white">{torrentData.medium}</td>
                        </tr>
                        <tr className="border-b border-gray-800">
                          <td className="px-4 py-2.5 text-gray-400">编码</td>
                          <td className="px-4 py-2.5 text-white">{torrentData.videoCodec}</td>
                        </tr>
                        <tr className="border-b border-gray-800">
                          <td className="px-4 py-2.5 text-gray-400">分辨率</td>
                          <td className="px-4 py-2.5 text-white">{torrentData.standard}</td>
                        </tr>
                        <tr className="border-b border-gray-800">
                          <td className="px-4 py-2.5 text-gray-400">音频</td>
                          <td className="px-4 py-2.5 text-white">{torrentData.audioCodec}</td>
                        </tr>
                        <tr className="border-b border-gray-800">
                          <td className="px-4 py-2.5 text-gray-400">制作组</td>
                          <td className="px-4 py-2.5 text-white">{torrentData.productionTeam}</td>
                        </tr>
                        <tr className="border-b border-gray-800">
                          <td className="px-4 py-2.5 text-gray-400">大小</td>
                          <td className="px-4 py-2.5 text-white">{formatSize(torrentData.size)}</td>
                        </tr>
                        <tr className="border-b border-gray-800">
                          <td className="px-4 py-2.5 text-gray-400">发布时间</td>
                          <td className="px-4 py-2.5 text-white text-xs">{torrentData.uploadDate}</td>
                        </tr>
                        <tr className="border-b border-gray-800">
                          <td className="px-4 py-2.5 text-gray-400">发布者</td>
                          <td className="px-4 py-2.5">
                            <span className="text-white">{torrentData.uploader}</span>
                            <Badge className="ml-2 bg-orange-500 text-white text-xs">{torrentData.uploaderLevel}</Badge>
                          </td>
                        </tr>
                        <tr className="border-b border-gray-800">
                ...
                <div className="bg-gray-900/50 rounded-lg border border-gray-800 overflow-hidden">
                  ...
                  <div className="p-4 space-y-4">
                    {relatedTorrents.map((torrent) => (
                      <div key={torrent.id} className="border border-gray-800 rounded-lg p-3 hover:border-gray-700 transition-colors cursor-pointer">
                        <h4 className="text-white text-sm mb-2 line-clamp-2">{torrent.title}</h4>
                ...
                <div className="bg-gray-900/50 rounded-lg border border-gray-800 p-4">
                  <div className="space-y-2">
                    <Button variant="outline" className="w-full border-gray-700 text-white hover:bg-gray-800 justify-start">
