                ...
                <div key={day.date} className="flex flex-col items-center gap-2">
                  <div className="flex items-end justify-center gap-1 h-32 w-full">
                    <div className="relative flex-1 flex flex-col justify-end">
                      <div className="bg-gradient-to-t from-amber-500 to-orange-600 rounded-t transition-all duration-500" style={{ height: `${createdHeight}%` }} title={`创建: ${day.created}`} />
                    </div>
                    <div className="relative flex-1 flex flex-col justify-end">
                      <div className="bg-gradient-to-t from-green-500 to-emerald-600 rounded-t transition-all duration-500" style={{ height: `${resolvedHeight}%` }} title={`解决: ${day.resolved}`} />
                    </div>
                  </div>
