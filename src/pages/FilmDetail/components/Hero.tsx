  ...
  return (
    <div className="relative h-auto pt-12">
      ...
      <div className="absolute inset-0">
        <ImageWithFallback src={detail.backdrop} alt={detail.title} className="w-full h-full object-cover" />
        ...
        <div className="flex flex-col md:flex-row gap-8 w-full">
          ...
          <div className="flex-shrink-0">
            <div className="w-48 md:w-64 rounded-lg overflow-hidden shadow-2xl border-2 border-gray-700">
              <ImageWithFallback src={detail.poster} alt={detail.title} className="w-full h-auto" width={256} height={384} />
            </div>
          </div>
          ...
          <div className="flex-1 space-y-4">
            {/* 标题与原名 */}
            <div>
              <h1 className="text-white text-4xl md:text-5xl mb-2">{detail.title}</h1>
              <p className="text-gray-300 text-lg md:text-xl">{detail.subtitle}</p>
            </div>
            ...
            <div className="flex flex-wrap items-center gap-3">
              ...
              <div className="flex items-center gap-2 bg-gray-900/80 px-3 py-1 rounded-full">
                ...
                <span className="text-gray-400 text-sm">({detail.ratingCount}人评分)</span>
              </div>
              <div className="flex items-center gap-2 bg-gray-900/80 px-3 py-1 rounded-full">
            ...
            {/* 简介 */}
            <p className="text-gray-300 text-base leading-relaxed max-w-3xl">{detail.description}</p>
            ...
            <div className="space-y-2 text-sm">
              ...
              <div className="flex gap-2">
                ...
                <span className="text-gray-300">{Array.isArray(detail.cast) ? detail.cast.join(' / ') : String(detail.cast ?? '')}</span>
              </div>
            </div>
            ...
            <div className="flex flex-wrap gap-3 pt-4">
              ...
              <Button variant="outline" className="bg-gray-900 border-gray-700 text-white hover:bg-gray-800 px-6 py-6">
