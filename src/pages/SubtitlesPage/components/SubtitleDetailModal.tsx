import { Award, Download, Flag, Link, MessageSquare, Star, ThumbsUp, Upload, User, X } from 'lucide-react';
...
export function SubtitleDetailModal({ subtitle, onClose }: { subtitle: Subtitle; onClose: () => void }) {
  return (
