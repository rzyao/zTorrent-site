...
import { availableTorrents } from '../constants';

export function UploadSubtitleModal({ open, onClose }: { open: boolean; onClose: () => void }) {
        ...
        <div className="p-6 space-y-5">
          <div>
            ...
            <div className="relative">
              <input type="file" accept=".srt,.ass,.ssa,.sub" onChange={handleFileChange} className="hidden" id="subtitle-file" />
          ...
          <div>
            ...
            <select
              ...
              onChange={(e) => setUploadForm((prev) => ({ ...prev, torrentId: e.target.value }))}
          ...
          <div className="flex gap-3 pt-4">
            ...
            <button onClick={onClose} className="px-6 py-3 bg-neutral-800 hover:bg-neutral-700 rounded-xl text-white transition-all">取消</button>
          </div>
        </div>
      </div>
    </div>
