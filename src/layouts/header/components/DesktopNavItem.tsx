...
export function DesktopNavItem({ item }: DesktopNavItemProps) {
  ...
  return (
    ...
    >
      ...
      <div
        className={`absolute top-full left-1/2 z-50 min-w-24 -translate-x-1/2 transform-gpu rounded-xl border border-gray-800 bg-[#0F171E] py-2 shadow-lg transition-[opacity,transform] duration-150 ease-out ${
          isOpen
